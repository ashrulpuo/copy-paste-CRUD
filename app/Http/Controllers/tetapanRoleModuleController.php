...
use App\Http\Requests\RoleModuleRequest;
use DataTables;
...
class RoleModuleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.emodule.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RoleModuleRequest $request)
    {
        $input = $request->all();

        DB::beginTransaction();
        try {
            RoleModule::create($input);
            DB::commit();
    ...
    {
        try {
            $RoleModule = RoleModule::where('RoleModuleId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RoleModule
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RoleModuleRequest $request, $id)
    {
        $input = $request->all();
        
        try {
            $RoleModule = RoleModule::where('RoleModuleId',$id)->get()->first();
            $RoleModule->update($input);
            return response()->json([
                'type' => 'success',
                'code' => 200,
    ...
    {
        try {
            $.'RoleModule' = 'RoleModuleId'::orderBy('DaftarPada', 'asc')
