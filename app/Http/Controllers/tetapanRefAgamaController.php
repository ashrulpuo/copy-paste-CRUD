...
use App\Http\Requests\RefAgamaRequest;
use DataTables;
...
class RefAgamaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.agama.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefAgamaRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefAgama = RefAgama::where('RefAgamaId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefAgama
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefAgamaRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefAgama' = 'RefAgamaId'::orderBy('DaftarPada', 'asc')
