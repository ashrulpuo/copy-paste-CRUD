...
use App\Http\Requests\RefGelaranRequest;
use DataTables;
...
class RefGelaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.gelaran.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefGelaranRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefGelaran = RefGelaran::where('RefGelaranId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefGelaran
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefGelaranRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefGelaran' = 'RefGelaranId'::orderBy('DaftarPada', 'asc')
