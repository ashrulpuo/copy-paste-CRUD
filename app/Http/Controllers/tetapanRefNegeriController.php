...
use App\Http\Requests\RefNegeriRequest;
use DataTables;
...
class RefNegeriController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.negeri.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefNegeriRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefNegeri = RefNegeri::where('RefNegeriId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefNegeri
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefNegeriRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefNegeri' = 'RefNegeriId'::orderBy('DaftarPada', 'asc')
