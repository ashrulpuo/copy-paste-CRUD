...
use App\Http\Requests\RefNegaraRequest;
use DataTables;
...
class RefNegaraController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.negara.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefNegaraRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefNegara = RefNegara::where('RefNegaraId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefNegara
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefNegaraRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefNegara' = 'RefNegaraId'::orderBy('DaftarPada', 'asc')
