...
use App\Http\Requests\RefJawatanRequest;
use DataTables;
...
class RefJawatanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.jawatan.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefJawatanRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefJawatan = RefJawatan::where('RefJawatanId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefJawatan
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefJawatanRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefJawatan' = 'RefJawatanId'::orderBy('DaftarPada', 'asc')
