...
use App\Http\Requests\RefBandarRequest;
use DataTables;
...
class RefBandarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.bandar.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefBandarRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefBandar = RefBandar::where('RefBandarId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefBandar
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefBandarRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefBandar' = 'RefBandarId'::orderBy('DaftarPada', 'asc')
