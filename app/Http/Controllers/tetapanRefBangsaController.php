...
use App\Http\Requests\RefBangsaRequest;
use DataTables;
...
class RefBangsaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.bangsa.index');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RefBangsaRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $RefBangsa = RefBangsa::where('RefBangsaId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $RefBangsa
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RefBangsaRequest $request, $id)
    {
        $input = $request->all();
        ($request->has('papar')) ?  $input['Papar'] = 1 :  $input['Papar'] = 0;
    ...
    {
        try {
            $.'RefBangsa' = 'RefBangsaId'::orderBy('DaftarPada', 'asc')
