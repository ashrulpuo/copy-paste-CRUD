...
class DUNController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DUNRequest $request)
    {
        $input = $request->all();
    ...
    {
        try {
            $DUN = DUN::where('DUNId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
                'data' => $DUN
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DUNRequest $request, $id)
    {
        $input = $request->all();
    ...
    {
        try {
            $.'DUN' = 'DUNId'::orderBy('DaftarPada', 'asc')
