...
class password_resetsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tetapan.sword_resets.index');
    }
    ...
    {
        try {
            $password_resets = password_resets::where('password_resetsId', $id)->get()->first();
            return response()->json([
                'type' => 'success',
                'code' => 200,
    ...
    {
        try {
            $.'password_resets' = 'password_resetsId'::orderBy('DaftarPada', 'asc')
