...
use App\BorangUndiPos;
use Illuminate\Http\Request;
use DB;
use Illuminate\Support\Str;
use App\Http\Requests\BorangUndiPosRequest;
use DataTables;
use Illuminate\Pagination\Paginator;

class BorangUndiPosController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(BorangUndiPosRequest $request)
    {
        $input = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(BorangUndiPosRequest $request, $id)
    {
        $input = $request->all();
