        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tetapan Jantina</h3>
                </div>
            ...
            <div class="card-body">
                <!--begin: Datatable-->
                <table class="table datatable-loaded" id="kt_datatable" data-route="{{ route('jantina.index') }}">
...
<script src="{{ asset('spr/js/tetapan/jantina.js') }}"></script>
@endsection                           
